...
const ContactForm = () => {
  return (
    <div className='max-w-7xl mx-auto md:px-6 md:grid grid-cols-12 gap-5 my-16'>
        ...
        <input className='md:w-64 w-full h-12 p-2 outline-none border mt-5 md:mt-0' type="email" placeholder='email'/>
        </div>
        <input className=' h-12 p-2 outline-none border mt-5' type="text" placeholder='subject'/>
        <textarea className=' h-12 p-2 outline-none border mt-5' type="text" placeholder='meassage' />
        <button className='border px-3 py-2 text-center w-28 mt-5 hover:text-orange-500 hover:border-orange-500'>Send</button>
        </div>
