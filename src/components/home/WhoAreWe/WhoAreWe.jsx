...
const WhoAreWe = () => {
  return (
    <div> <section className="dark:bg-gray-200 dark:text-gray-800  md:mt-0">
    <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12" bis_skin_checked="1">
      <div  className="block max-w-sm gap-3 mx-auto sm:max-w-full  lg:grid lg:grid-cols-12 place-items-center dark:bg-gray-50">
        <img src="https://i.postimg.cc/nV29vpYr/woman-6010055-1920.jpg" alt="" className="object-cover w-full h-64 rounded sm:h-96 lg:col-span-7 dark:bg-gray-500" />
        <div className="md:p-6 pt-9 space-y-2 lg:col-span-5" bis_skin_checked="1">
            
          <h3 className="text-2xl font-semibold sm:text-4xl font-playfair">Find Your <span className='text-orange-500 '>Best Travel</span> Details With Us</h3>
