...
<NavLink to={"int-packages"} className='flex items-center gap-2 font-nunito text-sm font-semibold p-2'><MdOutlineShoppingCart className='text-lg'  /> My International packages</NavLink>
...
<NavLink to={"int-ticket"} className='flex items-center gap-2 font-nunito text-sm font-semibold p-2'><IoTicketOutline className='text-lg'  /> My International Ticket</NavLink>
