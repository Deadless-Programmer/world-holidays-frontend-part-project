...
const AddNextTour = () => {
  ...
  const { control, handleSubmit } = useForm({
    defaultValues: {
      destination: "",
      price: { amount: "", currency: "BDT", per: "adult" },
      rating: 0,
      category: "",
      date_range: "",
      duration: "",
  ...
  const onSubmit = async (data) => {
    ...
    const reult = await axiosSecure
      .post("/next_tour", formattedData)
      .catch((error) => {
  ...
  return (
    <>
      <h1 className="text-3xl font-playfair md:pl-20 py-4 pl-4">
        Add Your Next Tour Data
      </h1>
      <form
      ...
      >
        ...
        <div style={{ display: "flex", gap: "20px", marginBottom: "16px" }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <Controller
              ...
              control={control}
              render={({ field }) => (
                <input type="number" step="0.1" style={inputStyle} {...field} />
              )}
            />
          </div>
        ...
        <div style={{ marginBottom: "16px" }}>
          <label style={labelStyle}>
            Tour Location Images (Comma Separated URLs)
          </label>
          <Controller
            name="tour_location_images"
            control={control}
            render={({ field }) => <input style={inputStyle} {...field} />}
          />
        </div>
